...
class Environment:
    ...
    def __init__(self,simulation_mode):
	    ...
	    # phys TODO: create instance of the physical elevator.
	    #Answer:
...
class ElevatorController:
    ...
    def run(self):
	    ...
	    #simu TODO: use the lambda structure above to run the while loop
	    #answer:
			...
			#simu TODO: complete one line of code for the required behavior
			#answer:
                        #self.close_the_door()  
                        key=0
	...
	#simu TODO: use two of the elevator properties to decide the required direction (1/-1) and save it to "direction" variables
	#answer:
    ...
    def move_to_floor(self,direction,sensor):
        while self.robot.step(self.timestep)!=-1:
            ...
            if sensor.getValue() > 0:
		#simu TODO: update the elevator state
		#answer:
                #self.state = "in_level"
                break 
    ...
    def open_the_door(self):      
		...
		#simu TODO: based on the "elev.setPosition" command update the door position
		#answer: 
    ...
    def close_the_door(self):
	    ...
	    #simu TODO: create while loop that closing the door. HINT: use "open_the_door" function
	    #answer:
            #while self.robot.step(self.timestep)!=-1:
...
class PhysicalElevatorController(ElevatorController):
    def __init__(self, elevator_id, pos_vector, levels,simulation_mode):
        ...
        self.Tsensors_dict={0:self.touch_sensor, 1:self.touch_sensor2, 2:self.touch_sensor3} 
	#phys TODO: create instance of keyboard. pay attention that you can't use the WEBOTS keyboard class.
	#answer:       
    ...
    def move_to_floor(self,direction,sensor):
		...
		#phys TODO: control the GPIO pins in the required diraction
		#answer:
                #GPIO.output(self.GPIO_PIN_UP, False)
        ...
        #stop the motor
	#phys TODO: control the GPIO pins to stop the elevator
	#answer:
...
class LedLight():
    ...
    def set(self,behavior=None):
		...
		#phys TODO: make the LED blinking
		#answer:
                #self.start_blinking()
            else:
...
if __name__ == "__main__":
	...
	#simu TODO: create instance of Environment class and run it
	#answer:
